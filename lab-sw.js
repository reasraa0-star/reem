var C='omarl-v1';
self.addEventListener('install',function(e){e.waitUntil(caches.open(C).then(function(c){return c.addAll(['./lab.html','./lab-manifest.json'])}).then(function(){return self.skipWaiting()}))});
...
self.addEventListener('fetch',function(e){
  if(e.request.method!=='GET')return;var u=new URL(e.request.url);
