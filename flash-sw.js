var C='flash-v1';
self.addEventListener('install',function(e){e.waitUntil(caches.open(C).then(function(c){return c.addAll(['./flash-admin.html','./flash-order.html','./flash-driver.html','./icon-192.png','./icon-512.png'])}).then(function(){return self.skipWaiting()}))});
